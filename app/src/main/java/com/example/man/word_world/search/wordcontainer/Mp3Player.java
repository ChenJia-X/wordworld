...
/**
 * Created by man on 2016/12/25.
 */
public class Mp3Player {
    public final static String MUSIC_ENG_RELATIVE_PATH="dictionary/sounds/sounds_EN/";
    public final static String MUSIC_USA_RELATIVE_PATH="dictionary/sounds/sounds_US/";
