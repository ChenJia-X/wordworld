package com.example.man.word_world.search.wordcontainer;
...
import com.example.man.word_world.search.internet.NetOperator;
import com.example.man.word_world.search.text_parser.JinShanContentHandler;
import com.example.man.word_world.search.text_parser.XMLParser;
...
//                "interpret text, sentorig text, senttrans text)");
        ...
        Cursor cursor = database.query(tableName, columns, "word=?", new String[]{searchedWord}, null, null, null);
    ...
    public String getPronEngUrl(String searchedWord) {
        Cursor cursor = database.query(tableName, new String[]{"prone"}, "word=?", new String[]{searchedWord}, null, null, null);
    ...
    public String getPronUSAUrl(String searchedWord) {
        Cursor cursor = database.query(tableName, new String[]{"prona"}, "word=?", new String[]{searchedWord}, null, null, null);
        if (cursor.moveToNext() == false) {
            cursor.close();
            return null;
        }
    ...
    public String getPsEng(String searchedWord) {
        Cursor cursor = database.query(tableName, new String[]{"pse"}, "word=?", new String[]{searchedWord}, null, null, null);
        if (cursor.moveToNext() == false) {
            cursor.close();
            return null;
        }
    ...
    public String getPsUSA(String searchedWord) {
        Cursor cursor = database.query(tableName, new String[]{"psa"}, "word=?", new String[]{searchedWord}, null, null, null);
        if (cursor.moveToNext() == false) {
            cursor.close();
            return null;
        }
    ...
    public String getInterpret(String searchedWord) {
        Cursor cursor = database.query(tableName, new String[]{"interpret"}, "word=?", new String[]{searchedWord}, null, null, null);
        if (cursor.moveToNext() == false) {
            cursor.close();
            return null;
        }
